...
export function ProjectPagination({ totalItems, itemsPerPage }: ProjectPaginationProps) {
  ...
  const handlePageChange = (newPage: number) => {
    ...
    router.push(`/projects?${current.toString()}`, { scroll: true }) // scroll to top when paginating
  }
